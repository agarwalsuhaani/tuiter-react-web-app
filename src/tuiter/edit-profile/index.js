    ...
    return(
        <>
            <div className="row mb-2">
                ...
                <div className="col-2">
                    <Link to = "/tuiter/profile" className="w-100 rounded-pill btn btn-dark float-end btn-sm border-right-2" onClick={() =>
            ...
            <div className="position-relative">
                <img src={profile.bannerPicture} style={{"width": "100%", "height": "200px"}}/>
                <br/>
                <img src={profile.profilePicture} style={{"width": "120px", "height": "120px", "bottom": "-50px", "left": "10px", "border": "solid 3px white"}}
